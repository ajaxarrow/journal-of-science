...
<div class="main-content-container">
	...
	<div class="p-5">
		<div class="flex justify-between items-center">
			<div class="relative">
				<input style="padding-left: 40px !important;" class="w-[290px] h-[49px] with-icon" type="text" placeholder="Search Authors"/>
				<i class="ph ph-magnifying-glass absolute left-3 top-1/2 transform -translate-y-1/2 text-[#5F6061] text-[20px]"></i>
			</div>
			<a class="btn-filled w-[159px] h-[49px]"><i class="ph ph-plus mr-2"></i> New Author</a>
		</div>
				...
				<?php foreach ($authors as $author): ?>
					<tr class="row-border">
						<th class="flex items-center gap-3 px-6 py-4 font-normal">
								<img
									class="avatar"
									src="<?php echo $author['author_image']; ?>"
									alt=""
								/>
							<div>
