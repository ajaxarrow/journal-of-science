	...
	<div class="register-sheet p-10 ">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
			<div class="my-3 lg:my-0">
				...
				<input class="w-full h-[45px]" type="text" placeholder="Enter Your First Name"/>
			</div>
			<div class="my-3 lg:my-0">
				<p class="font-medium">Last Name</p>
				<input class="w-full h-[45px]" type="text" placeholder="Enter Your Last Name"/>
			</div>
		</div>
		<div class="my-4">
			<p class="font-medium">Email</p>
			<input class="w-full h-[45px]" type="text" placeholder="Enter Your Email"/>
		</div>
		<div class="my-4">
